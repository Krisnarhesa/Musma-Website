        ...
        <ul>
          <li class="slide-overlay slide-overlay-gradient" data-transition="fade">
            ...
            <div class="tp-caption" data-x="center" data-hoffset="['-145','-145','-145','-320']" data-y="center"
              data-voffset="['-80','-80','-80','-130']" data-start="1000" data-transform_in="x:[-300%];opacity:0;s:500;"
              data-transform_idle="opacity:0.2;s:500;"><img src="img/slide-title-border.png" alt=""></div>
            ...
            <div class="tp-caption font-weight-extra-bold text-color-light p-3"
              ...
              data-x="center" data-hoffset="['0','0','0','0']" data-y="center" data-fontsize="['145','145','145','250']"
              data-lineheight="['150','150','150','260']">MUSMA
            </div>
      ...
      <div class="row justify-content-center pt-5 mt-5">
        <div class="col-lg-9 text-center">
          ...
          <div class="warning bg-danger" style="border: 1px solid black; border-radius: 5px;">
            <p class="warning-start pt-4 text-light appear-animation font-weight-bold pl-2 pr-2" data-aos="zoom-in"
              data-aos-delay="400"> @guest Silahkan
                login
                  ...
                  <div data-aos="fade-up" data-aos-delay="400" class="mt-6">
                    <label class="custom-radio">
                      ...
                      <span class="radio-btn"
                        style=" background: url('{{ $item->takeimage }}');background-size: cover;background-repeat-y: no-repeat;background-position: center; border: 10px solid transparent; border-image: url('{{ asset('img/photo-card.svg') }}') 40 round;"><i
            ...
            <div class="col-lg-auto appear-animation" data-aos="zoom-in" data-aos-delay="500">
              <div class="feature-box feature-box-style-2 d-block d-lg-flex">
                ...
                <div class="feature-box-info pl-1">
                  ...
                  <p class="mb-0">
                    <span class="social-icons-Instagram"><a href="https://www.instagram.com/smft_unud/" target="_blank"
                        class="text-color-light font-weight-semibold" title="SMFT UNUD"><i
                    ...
                    <span class="social-icons-twitter pl-1"><a href="https://smft.unud.ac.id/" target="_blank"
                        class="text-color-light font-weight-semibold" title="Website"><i class="mr-1 fa fa-globe"></i>
                          ...
                          <div> <span class="vertical-timeline-element-icon bounce-in"> <i
                            ...
                            <div class="vertical-timeline-element-content bounce-in">
                              ...
                              <p class="text-justify">Untuk mengetahui status verifikasi,
                                ...
                                poling.
                              </p> <span class="vertical-timeline-element-date"><i class="fas fa-arrow-down"></i></span>
                            </div>
                          </div>
                        </div>
                        <div class="vertical-timeline-item vertical-timeline-element">
